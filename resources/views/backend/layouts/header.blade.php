...
<header id="m_header" class="m-grid__item    m-header " m-minimize-offset="200" m-minimize-mobile-offset="200">
    <div class="m-container m-container--fluid m-container--full-height">
                            ...
                            <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
                                <ul class="m-menu__subnav">
                                    <li class="m-menu__item  m-menu__item--active " aria-haspopup="true"><a
                                                href="index-page=actions&amp;demo=demo12.html" class="m-menu__link "><i
                                        ...
                                        <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--right">
                                            ...
                                            <ul class="m-menu__subnav">
                                                <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
                                                    <a href="index-page=actions&amp;demo=demo12.html"
                                ...
                                <ul class="m-menu__subnav">
                                    ...
                                    <li class="m-menu__item  m-menu__item--submenu" m-menu-submenu-toggle="hover"
                                        m-menu-link-redirect="1" aria-haspopup="true"><a
                                                href="index-page=crud-datatable_v1&amp;demo=demo12.html"
                                                class="m-menu__link m-menu__toggle"><i
		...
		<span class="m-topbar__userpic">
			<img src="{{asset('images/hk.jpg')}}" class="m--img-rounded m--marginless m--img-centered" alt=""/>
		</span>
                                            ...
                                            <div class="m-dropdown__content">
                                                <ul class="m-nav m-nav--skin-light">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="index-page=profile&amp;demo=demo12.html"
                                                           class="m-nav__link">
